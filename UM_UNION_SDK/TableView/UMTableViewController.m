...
- (void)viewDidLoad
{
    ...
    _mTableView = [[UMUFPTableView alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, self.view.bounds.size.height-44) style:UITableViewStylePlain appkey:@"51f215d556240b3094053a48" slotId:nil currentViewController:self];
    ...
    _mLoadingWaitView.backgroundColor = UIColorFromRGB(0xf2f2f2);
    ...
    _mLoadingStatusLabel.textColor = UIColorFromRGB(0x999999);
    ...
    _mLoadingActivityIndicator.color = UIColorFromRGB(0x999999);
