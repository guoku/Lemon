...
- (UIColor*)currentInnerColor:(NSInteger)index
{
    ...
    switch (index) {
        case 9:
            color = [UIColor colorWithRed:180.0f / 255.0f green:178.0f / 255.0f blue:175.0 / 255.0f alpha:((0.2+0.2*_currentStep)>1)?((0.2+0.2*_currentStep)-1):(0.2+0.2*_currentStep)];
            break;
        case 7: case 8:
            color = [UIColor colorWithRed:180.0f / 255.0f green:178.0f / 255.0f blue:175.0 / 255.0f alpha:((0.4+0.2*_currentStep)>1)?((0.4+0.2*_currentStep)-1):(0.4+0.2*_currentStep)];
            break;
        case 4: case 5: case 6:
            color = [UIColor colorWithRed:180.0f / 255.0f green:178.0f / 255.0f blue:175.0 / 255.0f alpha:((0.6+0.2*_currentStep)>1)?((0.6+0.2*_currentStep)-1):(0.6+0.2*_currentStep)];
            break;
        case 2: case 3:
            color = [UIColor colorWithRed:180.0f / 255.0f green:178.0f / 255.0f blue:175.0 / 255.0f alpha:((0.8+0.2*_currentStep)>1)?((0.8+0.2*_currentStep)-1):(0.8+0.2*_currentStep)];
            break;
        case 1:
            color = [UIColor colorWithRed:180.0f / 255.0f green:178.0f / 255.0f blue:175.0 / 255.0f alpha:((1+0.2*_currentStep)>1)?((1+0.2*_currentStep)-1):(1+0.2*_currentStep)];
            break;
