...
@interface GKLoadingView (){
    ...
    GKLoadingTriangleUIView *frontLayerView;
    GKLoadingTriangleUIView *backLayerView;
    GKLoadingBGUIView *firstHalfFrontLayerView;
    GKLoadingBGUIView *secondHalfFrontLayerView;
	GKLoadingBGUIView *firstHalfBackLayerView;
	GKLoadingBGUIView *secondHalfBackLayerView;
    BOOL horizontal;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        frontLayerView = [[GKLoadingTriangleUIView alloc] init];
        ...
        backLayerView.color = frontColor;
        frontLayerView.center = self.center;
        
        backLayerView = [[GKLoadingTriangleUIView alloc] init];
...
-(void)checkFlipDirectionState {
    switch (flipState) {
        ...
        case kFlipStop:
        {
            ...
            UIColor *color = frontLayerView.color;
            frontLayerView.color = backLayerView.color;
            backLayerView.color = color;
            if (horizontal == NO) {
