...
- (id)initWithSectionTitles:(NSArray*)array {
	...
	if (self = [super initWithFrame:CGRectZero]) {
        ...
        //self.backgroundTintColor = [UIColor colorWithWhite:0 alpha:1];
        ...
        self.thumbEdgeInset = UIEdgeInsetsMake(2, 2, 3, 1);
...
- (void)drawRect:(CGRect)rect {
    ...
    if(self.backgroundImage)
        ...
        CGFloat components[8]  = {tintColorRGBA[0], tintColorRGBA[1], tintColorRGBA[2], tintColorRGBA[3],tintColorRGBA[0], tintColorRGBA[1], tintColorRGBA[2], tintColorRGBA[3]};
