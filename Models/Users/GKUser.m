...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:@(self.stage) forKey:@"pid"];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        self.stage = [[aDecoder decodeObjectForKey:@"pid"]intValue];
...
+ (void)globalUserLogoutWithBlock:(void (^)(BOOL is_logout, NSError * error))block
{
    ...
    [[GKAppDotNetAPIClient sharedClient] getPath:@"maria/logout/" parameters:[paramters Paramters] success:^(AFHTTPRequestOperation *operation, id JSON) {
