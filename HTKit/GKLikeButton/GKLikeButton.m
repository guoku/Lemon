...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [_likeButton setImage:[UIImage imageNamed:@"heard.png"] forState:UIControlStateSelected];
        [_likeButton setImage:[UIImage imageNamed:@"heard.png"] forState:UIControlStateSelected|UIControlStateHighlighted];
        [_likeButton setImage:[UIImage imageNamed:@"heard_gray.png"] forState:UIControlStateNormal];
         [_likeButton setImage:[UIImage imageNamed:@"heard_gray.png"] forState:UIControlStateNormal|UIControlStateHighlighted];
