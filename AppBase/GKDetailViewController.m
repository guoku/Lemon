...
- (void)showWebViewWithTaobaoUrl:(NSString *)taobao_url
{
    ...
    NSString *url = [NSString stringWithFormat:@"%@&sche=tb21563453&ttid=%@&sid=%@&type=mobile&outer_code=IPE",taobao_url, TTID,sid];
...
- (void)wxShare:(int)scene
{
    ...
    webPage.webpageUrl = [NSString stringWithFormat:@"%@e/%@/",kGK_WeixinShareURL,_data.entity_hash];
